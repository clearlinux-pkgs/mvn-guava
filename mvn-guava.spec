...
mkdir -p %{buildroot}/usr/share/java/.m2/repository/com/google/guava/guava/14.0.1
cp %{SOURCE4} %{buildroot}/usr/share/java/.m2/repository/com/google/guava/guava/14.0.1

mkdir -p %{buildroot}/usr/share/java/.m2/repository/com/google/guava/guava/19.0
cp %{SOURCE5} %{buildroot}/usr/share/java/.m2/repository/com/google/guava/guava/19.0

mkdir -p %{buildroot}/usr/share/java/.m2/repository/com/google/guava/guava/19.0
cp %{SOURCE6} %{buildroot}/usr/share/java/.m2/repository/com/google/guava/guava/19.0

mkdir -p %{buildroot}/usr/share/java/.m2/repository/com/google/guava/guava/25.1-android
cp %{SOURCE7} %{buildroot}/usr/share/java/.m2/repository/com/google/guava/guava/25.1-android

mkdir -p %{buildroot}/usr/share/java/.m2/repository/com/google/guava/guava/25.1-android
cp %{SOURCE8} %{buildroot}/usr/share/java/.m2/repository/com/google/guava/guava/25.1-android
